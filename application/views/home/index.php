...
<div class="container-fluid">
    ...
    <div class="row">
         ...
         <div class="col-xl-2 col-md-6 mb-4" id="barang">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-2 col-md-6 mb-4" id="supplier">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Pemasok
                            </div>
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-2 col-md-6 mb-4" id="kcb">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Kantor Cabang
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlkcb ?> Kota</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-users fa-2x text-gray-300"></i>
                        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="stok">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Stok Tersedia
                            </div>
                            <?php  
                                $data = $this->db->select_sum('jumlah_masuk')->from('barang_masuk')->get();
                                $data2 = $this->db->select_sum('jumlah_keluar')->from('barang_keluar')->get();
                                $data3 = $this->db->select_sum('stok')->from('barang_masuk')->get();


                                $bm = $data->row();
                                $bk = $data2->row();
                                $b = $data3->row();
                                $hasil = ($b->stok - intval($bk->jumlah_keluar));
                            ?>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $hasil ?> Stok Barang</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
                      <div class="card border-left-warning shadow h-100 py-2">
                        ...
                        <?php 
                            ...
                            echo " Selamat Malam !!";}
                            else { echo " <b> Selamat Malam </b>";}// menampilkan jam sekarang
                            echo "<br>Pukul : <b>". $jam." "."</b>";
                            $tanggal= mktime(date("m"),date("d"),date("Y"));
                            echo "<br> Tanggal : <b>".date("d-M-Y", $tanggal)."</b> ";
