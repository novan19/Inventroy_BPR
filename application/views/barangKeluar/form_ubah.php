                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Harga Barang</label>
                                <input class="form-control" name="harga" id="harga" type="number" value="<?= $d->harga ?>" >
                            </div>
                            ...
                            <!-- Total Harga Barang -->
                            <div class="form-group"><label>Total Nominal Barang</label>
                                <input class="form-control" name="total" id="total" type="number" value="<?= $d->total ?>" readonly>
                            </div>
