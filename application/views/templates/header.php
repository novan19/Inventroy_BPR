...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url(); ?>assets/icon/logoc.png">
    <title>Inventory BPR KMA | <?= $title ?></title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <img src="<?=site_url('assets/Icon/logoc.png')?>" class="img-circle" alt="User Image" style="height: 60px;">
        </div>
                <div class="sidebar-brand-text mx-1"><img src="<?=site_url('assets/Icon/bpr.png')?>" class="img-circle" alt="User Image" style="height: 50px;"></div>
            </a>
            ...
            <li class="nav-item">
                <?php endif; ?>
                <a class="nav-link" href="<?= base_url() ?>kcb">
                    <i class="fas fa-fw fa-users"></i>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>jenis"><b>Kategori Barang</b></a>
                        <?php endif; ?>
                        <?php if($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'superadmin'): ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php if($this->session->userdata('login_session')['level'] == 'admin'): ?>
                        <a class="collapse-item" href="<?= base_url() ?>barang_masuk"><b>Pembelian Barang</b></a>
                         <?php endif; ?>
                        <a class="collapse-item" href="<?= base_url() ?>barang_keluar"><b>Pemakaian Barang</b></a>
            ...
            <?php if($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'superadmin' || $this->session->userdata('login_session')['level'] == 'direktur'): ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>lap_barang"><b>Lap Barang</b></a>
                        <a class="collapse-item" href="<?= base_url() ?>lap_barang_masuk"><b>Lap Pembelian Barang</b></a>
                        <a class="collapse-item" href="<?= base_url() ?>lap_barang_keluar"><b>Lap Pemakaian Barang</b></a>
                    </div>
