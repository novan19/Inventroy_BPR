        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white font-weight-bold" id="exampleModalLabel">Tambah Pemasok</h5>
                ...
                <div class="col-lg-12">
                    ...
                    <!-- Alamat -->
                    <div class="form-group"><label>Nama Sales</label>
                        <textarea class="form-control" name="nama_sales"></textarea>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="col-lg-12">
                    <br>
                    <!-- Id Supplier -->
                    <div class="form-group"><label>ID Pemasok</label>
                        <input class="form-control" name="idsupplier" type="text" id="idsupplier" readonly>
                    </div>

                    <!-- Nama Supplier -->
                    <div class="form-group"><label>Nama Pemasok</label>
                    ...
                    <!-- Alamat -->
                    <div class="form-group"><label>Nama Sales</label>
                        <textarea class="form-control" name="nama_sales" id="nama_sales"></textarea>
                    </div>
